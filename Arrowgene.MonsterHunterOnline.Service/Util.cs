    ...
    public static class Util
    {
        ...
        public static List<Dictionary<string, string>> DebugGetVersions()
        {
            ...
            foreach (Assembly assembly in assemblies)
            {
                ...
                if (!asmName.StartsWith("Arrowgene.MonsterHunterOnline"))
                {
                    continue;
                }
        ...
        public static string GetVersion(string mhoComponent)
        {
            ...
            {
                if (version["name"] != $"Arrowgene.MonsterHunterOnline.{mhoComponent}")
                {
                    continue;
                }
