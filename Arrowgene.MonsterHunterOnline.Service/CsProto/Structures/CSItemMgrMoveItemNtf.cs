...
namespace Arrowgene.MonsterHunterOnline.Service.CsProto.Structures
{
    ...
    /// 通知移动物品
    /// </summary>
    public class CSItemMgrMoveItemNtf : IStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrMoveItemNtf));

        public CSItemMgrMoveItemNtf()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
