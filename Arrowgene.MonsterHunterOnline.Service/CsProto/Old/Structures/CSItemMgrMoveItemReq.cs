...
namespace Arrowgene.MonsterHunterOnline.Service.CsProto.Structures
{
    ...
    /// 请求移动物品
    /// </summary>
    public class CSItemMgrMoveItemReq : IStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrMoveItemReq));

        public CSItemMgrMoveItemReq()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
