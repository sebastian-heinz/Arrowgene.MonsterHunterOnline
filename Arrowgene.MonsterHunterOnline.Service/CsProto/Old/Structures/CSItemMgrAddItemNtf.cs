...
namespace Arrowgene.MonsterHunterOnline.Service.CsProto.Structures
{
    ...
    /// 通知客户端添加物品
    /// </summary>
    public class CSItemMgrAddItemNtf : IStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrAddItemNtf));

        public CSItemMgrAddItemNtf()
        {
            Reason = 0;
