...
namespace Arrowgene.MonsterHunterOnline.Service.CsProto.Structures
{
    ...
    /// 服务器强制状态变化消息
    /// </summary>
    public class CSServerSyncInfoNtf : IStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSServerSyncInfoNtf));

        public CSServerSyncInfoNtf()
        {
            EntityId = 0;
